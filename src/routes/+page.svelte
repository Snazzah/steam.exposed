...
<main class="flex flex-col items-center justify-center min-h-screen gap-8 px-6 my-10 md:my-0" data-sveltekit-reload>
  ...
  <div class="flex flex-col gap-4 w-full items-center">
    ...
    {:else}
      <div class="flex gap-2 w-full max-w-lg text-white">
        ...
        >
          <img src={data.sessionUser.avatarmedium} class="w-6 h-6 rounded" alt={data.sessionUser.personaname} />
