...
>
  {#if highlight}
    <span class="absolute top-0 bottom-0 left-0 right-0 ring-2 ring-offset-2 ring-blue-500 ring-offset-neutral-950 pointer-events-none select-none rounded animate-pulse" />
  {/if}
  {#if icon}
